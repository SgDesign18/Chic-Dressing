...
<div class="main-container">
	...
	echo '<h2 id="leblog" class="chic-title">Conseils de créateurs </h2>';
	...
	echo '</ul>';
	echo '<p class="text-center"><a class="chic-bouton" href="http://localhost/chic/#leblog">Voir tous les articles</a></p>';
